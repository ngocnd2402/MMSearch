...
def process_batch(batch_path, output_json, processor, model):
    ...
    for root, dirs, files in os.walk(batch_path):
        ...
        dirs[:] = sorted_dirs  # Sắp xếp lại dirs để os.walk duyệt theo thứ tự tự nhiên
...
model = model.to('cuda')
root_path = "/mmlabworkspace/Datasets/AIC2023/"
json_path = "/home/visedit/WorkingSpace/AIC2023/JSON/"
