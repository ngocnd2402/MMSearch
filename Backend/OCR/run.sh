...
CROPPED_FOLDER=/mmlabworkspace/Students/visedit/AIC2023/Backend/OCR/mmocr/inference-result/crop-image1
DROPPED_FOLDER=/mmlabworkspace/Students/visedit/AIC2023/Backend/OCR/mmocr/inference-result/drop-image1
JSON_FOLDER=/mmlabworkspace/Students/visedit/AIC2023/Backend/OCR/mmocr/inference-result/json1
PARSEQ_FILE=rec_result1.txt
...
do
    ...
    do
        ...
        CUDA_VISIBLE_DEVICES=0 python mmocr/utils/ocr.py $KEYFRAME_DIR_LV_2 \
            ...
            --export $JSON_FOLDER \
            --det-batch-size 512
            # --output /mmlabworkspace/Students/visedit/AIC2023/Backend/OCR/mmocr/inference-result/visualization \
