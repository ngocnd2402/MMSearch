...
CROPPED_FOLDER=/mmlabworkspace/Students/visedit/AIC2023/Backend/OCR/mmocr/inference-result/crop-image3
DROPPED_FOLDER=/mmlabworkspace/Students/visedit/AIC2023/Backend/OCR/mmocr/inference-result/drop-image3
JSON_FOLDER=/mmlabworkspace/Students/visedit/AIC2023/Backend/OCR/mmocr/inference-result/json3
PARSEQ_FILE=rec_result3.txt
...
do
    ...
    if [[ "$dir_lv_1" < "L21" || "$dir_lv_1" > "L35" ]]; then
        continue
    fi
